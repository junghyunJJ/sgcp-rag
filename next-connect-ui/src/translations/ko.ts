export const ko = {
  ...
  search: {
    ...
    agenticSearch: 'Agentic 검색',
    standardSearch: '일반 검색',
    agenticDescription: 'AI 기반 자동 쿼리 재작성 및 답변 생성 검색',
    askQuestion: '질문을 입력하세요...',
    maxRewrites: '최대 쿼리 재작성 횟수',
    aiAnswer: 'AI 답변',
    sourceDocuments: '참조 문서',
    executionSteps: '실행 단계',
    queryRewrites: '쿼리 재작성',
    agenticSearching: 'AI가 질문을 분석하고 있습니다...',
    agenticNoAnswer: '답변을 생성할 수 없습니다. 질문을 다시 작성해 보세요.',
    cancelSearch: '취소',
    rewriteHistory: '원본 → 재작성',
    stepRetrieve: '문서 검색 중',
    stepGrade: '관련도 평가 중',
    stepGenerate: '답변 생성 중',
    stepRewrite: '쿼리 재작성 중',
    stepCheck: '답변 검증 중',
  },
  apiTester: {
    title: 'API 테스터',
